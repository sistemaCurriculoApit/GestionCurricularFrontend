...
const routesFilter = routes.filter(route => (route.layout === '/docente'));
...
class DashboardDocente extends React.Component<Props, State> {
  refs: any;
...
export default withStyles(dashboardStyle)(DashboardDocente);
